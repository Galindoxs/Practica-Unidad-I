    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="{{route('vuelo.agregarNuevo')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="numeroAsiento" class="form-control"/>
                    </div>

                    
                    <br>
                    <div class="form-group">
                        <a class="btn btn-warning" href="{{route('vuelo.inicio')}}">Volver</a>
